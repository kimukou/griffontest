...
public class JPagingPanel extends JComponent {
    ...
    private void initPagingBox() {
        ...
        p.setSize(new Dimension(116, 47));
        p.setLayout(null);
        ...
        p2.setSize(new Dimension(116, 25));
        p2.setLayout(null);
...
*/
    ...
    private JPanel getJPanel() {
        ...
        panel.setBounds(new Rectangle(5, 6, 110, 30));
        ...
        pageLabel.setBounds(new Rectangle(3, 0, 38, 32));
        panel.add(pageLabel);
        panel.add(getPageTextField(), null);
        JLabel maxPageLabel = new JLabel();
        maxPageLabel.setText("");
        maxPageLabel.setBounds(new Rectangle(72, 0, 52, 32));
    ...
    private JTextField getPageTextField() {
        ...
        pageTextField.setBounds(new Rectangle(39, 3, 30, 24));
    ...
    private FirstButton getFirstButton() {
        ...
        firstButton.setBounds(new Rectangle(0, 6, 28, 25));
    ...
    private PrevButton getPrevButton() {
        ...
        prevButton.setBounds(new Rectangle(30, 6, 28, 25));
    ...
    private NextButton getNextButton() {
        ...
        nextButton.setBounds(new Rectangle(60, 6, 28, 25));
    ...
    private EndButton getEndButton() {
        ...
        endButton.setBounds(new Rectangle(90, 6, 28, 25));
